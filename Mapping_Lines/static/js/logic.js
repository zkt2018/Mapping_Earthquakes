...
// 1.0.4.1 Get data from cities.js
// let cityData = cities;

// Loop through the cities array and create a cicle marker for each city that has a radius equivalent to the city's population
